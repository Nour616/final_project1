...
class _StudentScheduleScreenState extends State<StudentScheduleScreen> {
  ...
  Future<File> _saveImageToLocalStorage(File imageFile) async {
    ...
    final File newImage = await imageFile.copy('$path/student_schedule.jpg');

    SharedPreferences prefs = await SharedPreferences.getInstance();
    prefs.setString('student_saved_image', newImage.path);
  ...
  Future<void> _loadSavedImage() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    String? savedImagePath = prefs.getString('student_saved_image');
  ...
  Future<void> _clearImage() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    await prefs.remove('student_saved_image');
    setState(() {
      _selectedImage = null;
    });
  }
